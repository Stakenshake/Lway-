...
def model_import(model_name, scale, load_weights=False):
    ...
    elif model_name == 'LRRec':
        from Model.Lway import LRReconstructionModel
        model = LRReconstructionModel()                             #problem?
    elif model_name == 'SwinIR':
        from Model.Lway import SelfSupervisedModel
        model = SelfSupervisedModel()                               #problem?
